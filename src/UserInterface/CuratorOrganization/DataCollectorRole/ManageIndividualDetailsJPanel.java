...
public class ManageIndividualDetailsJPanel extends javax.swing.JPanel {
 private JPanel userProcessContainer;
    ...
    private void addRecordButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRecordButtonActionPerformed
        ...
        if(!Validator.StringEmpty(txtName.getText()) && !Validator.StringEmpty(txtIncome.getText())){
       String name = txtName.getText();
       int age = Integer.parseInt( ageCombo.getSelectedItem().toString());
       String gender = genderCombo.getSelectedItem().toString();
       if(!Validator.isNumeric(txtIncome.getText()).equalsIgnoreCase("")){
           JOptionPane.showMessageDialog(null, Validator.isNumeric(txtIncome.getText()), "Error", JOptionPane.ERROR_MESSAGE);
           return;
       }
       int income = Integer.parseInt(txtIncome.getText());
       String requestType=jobRadioButton.isSelected() ? Constant.TR_REQUESTTYPE_JOB:Constant.TR_REQUESTTYPE_EDU;
       ...
       for (Organization og : enterprise.getOrganizationList().getOrganizationList()){
           ...
           if (og instanceof JobRequestManagerOrganization){
            ...
            if (org!=null){
                if(requestType.equalsIgnoreCase(Constant.TR_REQUESTTYPE_JOB)){
                ...
                else if(requestType.equalsIgnoreCase(Constant.TR_REQUESTTYPE_EDU)){
